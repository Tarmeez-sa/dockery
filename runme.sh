...
startInstall()
{
   # clear
    ...
    if [[ "$NPM" == [yY] ]]; then
        ...
        wget https://raw.githubusercontent.com/tarmeez/dockery/main/docker-compose.yml
...
#
# EOF
#         curl -s https://raw.githubusercontent.com/tarmeez-sa/odoo16-docker-sh/main/run.sh | sudo bash -s odoo-16-one 8016 20016
#
#  cat << "EOF"
#
# '####:'##::: ##::'######::'########::::'###::::'##:::::::'##:::::::::::'#######::'########:::'#######:::'#######:::::::::::'##:::'########:
...
#
#
#         curl -s https://raw.githubusercontent.com/tarmeez-sa/odoo15-d0cker-sh/main/run.sh | sudo bash -s odoo-15-one 8015 20015
#
#
#          cat << "EOF"
#
...
EOF
        ...
        curl -s https://raw.githubusercontent.com/Tarmeez-sa/odoo-18-docker-compose/main/run.sh | sudo bash -s odoo-18-one 8018 20018
...
EOF
        ...
        curl -s https://raw.githubusercontent.com/Tarmeez-sa/odoo-17-docker-compose/main/run.sh | sudo bash -s odoo-17-one 8017 20017
